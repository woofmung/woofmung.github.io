import{c as t,r as a,m as n}from"./render-template.zu4OLyYC.js";import{u as r}from"./hoisted.e3IDx96y.js";import"./astro/assets-service.adgvQEOQ.js";const e=`<h2 id="adding-your-own-social-image-to-a-post">Adding your own social image to a post</h2>
...
</section>`,s={title:"Example OG Social Image",publishDate:"27 January 2023",description:"An example post for Astro Cactus, detailing how to add a custom social image card in the frontmatter",tags:["example","blog","image"],ogImage:"/social-card.png",minutesRead:"1 min read"},i="/home/runner/work/woofmung/woofmung/src/content/post/social-image.md",l=void 0;function h(){return`
...
`}function y(){return e}function w(){return[{depth:2,slug:"adding-your-own-social-image-to-a-post",text:"Adding your own social image to a post"},{depth:2,slug:"footnote-label",text:"Footnotes"}]}const b=t((p,c,g)=>{const{layout:m,...o}=s;return o.file=i,o.url=l,a`${n()}${r(e)}`});export{b as Content,y as compiledContent,b as default,i as file,s as frontmatter,w as getHeadings,h as rawContent,l as url};
