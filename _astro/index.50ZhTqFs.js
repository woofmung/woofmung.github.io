...
`,n(e.p,{children:n(r,{src:w,alt:"A pug in the woods, wrapped in a blanket"})}),`
...
`]})]})}function x(t={}){const{wrapper:e}=t.components||{};return e?n(e,{...t,children:n(a,{...t})}):a(t)}const j="src/content/post/hello-world/index.mdx",H="/home/runner/work/woofmung/woofmung/src/content/post/hello-world/index.mdx",s=(t={})=>x({...t,components:{Fragment:d,...t.components,"astro-image":t.components?.img??g}});s[Symbol.for("mdx-component")]=!0;s[Symbol.for("astro.needsHeadRendering")]=!b.layout;s.moduleId="/home/runner/work/woofmung/woofmung/src/content/post/hello-world/index.mdx";export{s as Content,C as __usesAstroImage,s as default,H as file,b as frontmatter,_ as getHeadings,j as url};
